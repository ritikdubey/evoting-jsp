...
<h1> Following data is recorded, you are ready to contest: </h1>
...
<button class="btn btn-outline-primary btn-md" onClick="window.location.href='index.html'" style="margin-top: 8%; left: 40%;"> Back to Homepage </button>
